...
- `world/<id>/card.json` + `ref.png`=**世界風土庫**(場景、道具、風土素材:公會大廳、告示板、貨幣、文字筆跡、街市攤位…)。跟角色庫同形狀,分鏡用 `panel.world: ["node_guild_hall"]` 指名,生圖時當這一格的**場景鎖**附上去——沒有它,同一個大廳每格都會重抽一個樣子
  - **平面圖與文字的分工**:平面圖是幾何的**唯一事實來源**(鏡頭站哪、朝哪、看得到多寬);`cameras` 的文字**只補圖上表達不了的**——鏡頭高度(站姿/坐姿/俯視)、取景鬆緊、誰在最前面。**文字不准寫「左邊是⋯右邊是⋯背景是⋯」**:那些是相對於鏡頭的,鏡頭一換就錯,而且會跟圖打架
  - **站位也要用絕對方位**:「櫃檯貼在與大門相對的那面牆」「小桌在櫃檯右手邊靠右牆那側」,不要寫「右後角」——左右會隨機位翻轉。實測事故:一個常駐配角被要求「永遠要畫出來」,但有些機位的鏡頭背對他,模型只好把他塞到畫面裡隨便一個角落,看起來像他一直在換位子
  - **鏡頭拍不到的人不要硬塞**:常駐人物的規矩要加前提——「只要他的位置落在這一格的視野扇形裡才畫」
